...
mod tests {
    ...
    fn test_top_like_header_compatibility() {
        ...
        top_output.chars().for_each(|c| processor.process_bytes(&[c as u8]));
    ...
    fn test_nano_editor_compatibility() {
        ...
        let nano_output = "\x1b[H\x1b[2J  GNU nano 4.8                    main.rs                             \n";
    ...
    fn test_htop_process_list_compatibility() {
        ...
        htop_output.chars().for_each(|c| processor.process_bytes(&[c as u8]));
