#[cfg(test)]
mod tests {
    use crate::draw_loop::{detect_move_area, calculate_new_position};
    ...
    fn test_calculate_new_position_movement() {
        ...
        let new_position = calculate_new_position(
            &original_bounds,
            20, 10, // start_x, start_y
            30, 15, // current_x (+10), current_y (+5)
            100,    // terminal_width
            50,     // terminal_height
        );
    ...
    fn test_calculate_new_position_boundary_constraints() {
        ...
        let new_position = calculate_new_position(
            &original_bounds,
            90, 40, // start position
            120, 45, // try to move way right and down
            100,    // terminal_width
            50,     // terminal_height
        );
