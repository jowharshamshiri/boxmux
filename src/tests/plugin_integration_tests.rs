...
mod plugin_integration_tests {
    ...
    fn test_panel_plugin_content_generation() {
        ...
        plugin_config.insert("title".to_string(), serde_json::Value::String("Test Chart".to_string()));
        plugin_config.insert("refresh_rate".to_string(), serde_json::Value::Number(serde_json::Number::from(1000)));
    ...
    fn test_panel_plugin_without_component_type() {
        ...
        let mut plugin_config = HashMap::new();
        plugin_config.insert("data".to_string(), serde_json::Value::String("test".to_string()));
        panel.plugin_config = Some(plugin_config);
    ...
    fn test_plugin_content_priority() {
        ...
        let mut plugin_config = HashMap::new();
        plugin_config.insert("mode".to_string(), serde_json::Value::String("test".to_string()));
        panel.plugin_config = Some(plugin_config);
    ...
    fn test_plugin_config_serialization() {
        ...
        let mut plugin_config = HashMap::new();
        plugin_config.insert("columns".to_string(), serde_json::json!(["Name", "Value", "Status"]));
        plugin_config.insert("sort_by".to_string(), serde_json::Value::String("Name".to_string()));
        plugin_config.insert("page_size".to_string(), serde_json::Value::Number(serde_json::Number::from(25)));
        panel.plugin_config = Some(plugin_config);
