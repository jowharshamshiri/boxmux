...
mod plugin_integration_tests {
    ...
    #[test]
    fn test_muxbox_plugin_content_generation() {
        let mut muxbox = MuxBox::default();
        muxbox.id = "test_plugin".to_string();
        muxbox.plugin_component = Some("custom_chart".to_string());
        ...
        muxbox.plugin_config = Some(plugin_config);
    ...
    #[test]
    fn test_muxbox_no_plugin_config() {
        let mut muxbox = MuxBox::default();
        muxbox.id = "test_no_plugin".to_string();
    ...
    #[test]
    fn test_muxbox_plugin_without_component_type() {
        let mut muxbox = MuxBox::default();
        muxbox.id = "test_no_component".to_string();
        // No plugin_component
    ...
    fn test_plugin_content_priority() {
        ...
        let mut muxbox = MuxBox::default();
        muxbox.id = "test_priority".to_string();
        muxbox.content = Some("Static content".to_string());
        muxbox.plugin_component = Some("custom_widget".to_string());
        ...
        muxbox.output = "Script output".to_string();
    ...
    fn test_plugin_config_serialization() {
        let mut muxbox = MuxBox::default();
        muxbox.id = "test_serialization".to_string();
        muxbox.plugin_component = Some("data_table".to_string());
    ...
    fn test_complex_plugin_config() {
        let mut muxbox = MuxBox::default();
        muxbox.id = "test_complex".to_string();
        muxbox.plugin_component = Some("dashboard_widget".to_string());
        muxbox.refresh_interval = Some(5000);
        ...
        if let serde_json::Value::Object(map) = plugin_config {
            ...
            muxbox.plugin_config = Some(hashmap);
        }
