...
mod tests {
    ...
    use crate::draw_loop::{get_panel_content_for_clipboard, copy_to_clipboard};
    ...
    fn test_get_panel_content_output_priority() {
        ...
        assert_eq!(clipboard_content, "Dynamic output", "Panel output should take priority over static content");
    }
    ...
    fn test_get_panel_content_static_content() {
        ...
        let clipboard_content = get_panel_content_for_clipboard(&panel);
        assert_eq!(clipboard_content, "Static panel content", "Should use static content when output is empty");
    }
    ...
    fn test_get_panel_content_no_content() {
        ...
        let clipboard_content = get_panel_content_for_clipboard(&panel);
        assert_eq!(clipboard_content, "Panel 'empty_panel': No content", "Should provide informative message for empty panels");
    }
    ...
    fn test_get_panel_content_multiline() {
        ...
        let clipboard_content = get_panel_content_for_clipboard(&panel);
        assert_eq!(clipboard_content, "Line 1\nLine 2\nLine 3", "Should preserve multiline content exactly");
    }
