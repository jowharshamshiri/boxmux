...
"#;
    ...
    initial_frame
        .assert_contains_text("REGRESSION_TEST_CHOICE_1")
        .expect("Choice 1 not found");
    initial_frame
        .assert_contains_text("REGRESSION_TEST_CHOICE_2")
        .expect("Choice 2 not found");
    initial_frame
        .assert_contains_text("REGRESSION_TEST_CHOICE_3")
        .expect("Choice 3 not found");
    ...
    selection_frame
        .assert_contains_text("REGRESSION_TEST_CHOICE_2...")
        .expect("Selection feedback not shown");
    ...
    execution_frame
        .assert_contains_text("REGRESSION_CHOICE_2_EXECUTED")
        .expect("Execution output not found");
    ...
    assert!(
        !final_text.contains("REGRESSION_TEST_CHOICE_2..."),
    ...
    third_selection_frame
        .assert_contains_text("REGRESSION_TEST_CHOICE_3...")
        .expect("Third choice selection not shown");

    std::thread::sleep(Duration::from_millis(300));
    let third_execution_frame = tester.wait_for_frame().expect("Failed to capture frame");
    third_execution_frame
        .assert_contains_text("REGRESSION_CHOICE_3_EXECUTED")
        .expect("Third choice execution not found");

    println!("REGRESSION TEST: All choice clicking functionality verified ✓");

    // Print final frame for debugging if needed
    println!(
        "REGRESSION TEST FINAL FRAME:\n{}",
...
"#;
    ...
    after_execution
        .assert_contains_text("BOUNDS_SHORT_EXECUTED")
        .expect("Execution output not found");
    ...
    assert!(
        waiting_count <= 1, // At most the previous execution remnant
    ...
    long_choice_frame
        ...
        .expect("Long choice selection not shown");
    ...
    long_choice_executed
        .assert_contains_text("BOUNDS_LONG_EXECUTED")
        .expect("Long choice execution not found");
