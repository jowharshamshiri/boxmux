...
mod pty_process_info_tests {
    ...
    fn test_process_info_is_running_logic() {
        ...
        let info = pty_manager.get_detailed_process_info("running_panel").unwrap();
        assert_eq!(info.is_running, true);
        ...
        let info = pty_manager.get_detailed_process_info("starting_panel").unwrap();
        assert_eq!(info.is_running, true);
        ...
        let info = pty_manager.get_detailed_process_info("finished_panel").unwrap();
