...
mod tests {
    ...
    fn test_click_region_detection() {
        ...
        assert_eq!(
            mouse_dims.detect_click_region(20, 5),
            ClickRegion::VerticalScrollbar
        );

        // Horizontal scrollbar (bottom edge)
        assert_eq!(
            mouse_dims.detect_click_region(10, 10),
            ClickRegion::HorizontalScrollbar
        );
