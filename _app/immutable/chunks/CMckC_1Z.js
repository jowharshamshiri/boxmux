...
boxmux replace-muxbox-content <span class="token string">"status_box"</span> <span class="token string">"New status: Online"</span>
...
<span class="token key atrule">boxes</span><span class="token punctuation">:</span>
  <span class="token key atrule">remote_controlled</span><span class="token punctuation">:</span>
    ...
    <span class="token comment"># boxmux replace-muxbox-content "remote_controlled" "New content"</span></code>`),n(y);var h=s(y,6),U=a(h);t(U,()=>`<code class="language-yaml"><span class="token key atrule">boxes</span><span class="token punctuation">:</span>
