...
<span class="token key atrule">on_keypress</span><span class="token punctuation">:</span>
  ...
  <span class="token key atrule">system_stats</span><span class="token punctuation">:</span>
    ...
    <span class="token key atrule">libs</span><span class="token punctuation">:</span> <span class="token punctuation">[</span><span class="token string">"utils.sh"</span><span class="token punctuation">]</span>              <span class="token comment"># Include script libraries</span></code>`),a(l);var u=s(l,4),z=n(u);t(z,()=>`<code class="language-yaml"><span class="token key atrule">boxes</span><span class="token punctuation">:</span>
  <span class="token key atrule">main_menu</span><span class="token punctuation">:</span>
    ...
    <span class="token key atrule">selected_color</span><span class="token punctuation">:</span> <span class="token string">"BrightYellow"</span></code>`),a(u);var k=s(u,4),P=n(k);t(P,()=>`<code class="language-yaml"><span class="token key atrule">boxes</span><span class="token punctuation">:</span>
  ...
  <span class="token key atrule">main_container</span><span class="token punctuation">:</span>
    ...
    <span class="token key atrule">children</span><span class="token punctuation">:</span>
      ...
      <span class="token key atrule">content</span><span class="token punctuation">:</span>
        ...
        <span class="token comment"># Main content area</span></code>`),a(r);var y=s(r,6),G=n(y);t(G,()=>`<code class="language-yaml"><span class="token comment"># Hierarchical variable definition</span>
<span class="token key atrule">variables</span><span class="token punctuation">:</span>
...
<span class="token key atrule">boxes</span><span class="token punctuation">:</span>
  ...
  <span class="token key atrule">api_status</span><span class="token punctuation">:</span>
    ...
    <span class="token key atrule">script</span><span class="token punctuation">:</span> <span class="token string">"curl -s &#123;&#123;endpoint&#125;&#125; | jq '.status'"</span></code>`),a(y);var g=s(y,4),R=n(g);t(R,()=>`<code class="language-yaml"><span class="token key atrule">boxes</span><span class="token punctuation">:</span>
...
<span class="token key atrule">hot_keys</span><span class="token punctuation">:</span>
  ...
  <span class="token key atrule">"Ctrl+t"</span><span class="token punctuation">:</span>
    ...
    <span class="token key atrule">box_id</span><span class="token punctuation">:</span> <span class="token string">"actions"</span></code>`),a(h);var b=s(h,6),I=n(b);t(I,()=>`<code class="language-yaml"><span class="token comment"># Standard colors</span>
...
<span class="token key atrule">boxes</span><span class="token punctuation">:</span>
  ...
  <span class="token key atrule">warning_box</span><span class="token punctuation">:</span>
    ...
    <span class="token key atrule">foreground_color</span><span class="token punctuation">:</span> <span class="token string">"&#123;&#123;theme.warning&#125;&#125;"</span></code>`),a(b);var _=s(b,6),O=n(_);t(O,()=>`<code class="language-yaml"><span class="token comment"># Global refresh settings</span>
<span class="token key atrule">refresh_rate</span><span class="token punctuation">:</span> <span class="token number">50</span>                    <span class="token comment"># Global refresh interval (ms)</span>
