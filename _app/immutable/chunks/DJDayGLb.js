...
<span class="token key atrule">variables</span><span class="token punctuation">:</span>
  ...
  <span class="token key atrule">X</span><span class="token punctuation">:</span> <span class="token string">"30"</span>                             <span class="token comment"># Meaningless</span></code>`),a(E);var y=s(E,4),x=n(y);t(x,()=>`<code class="language-yaml"><span class="token comment"># Always provide fallback values for optional configuration</span>
<span class="token key atrule">script</span><span class="token punctuation">:</span>
  ...
  <span class="token punctuation">-</span> <span class="token string">'echo "Log level: $&#123;LOG_LEVEL:info&#125;"'</span></code>`),a(y);var m=s(y,4),G=n(m);t(G,()=>`<code class="language-yaml"><span class="token key atrule">app</span><span class="token punctuation">:</span>
  <span class="token key atrule">variables</span><span class="token punctuation">:</span>
...
<span class="token punctuation">-</span> <span class="token key atrule">id</span><span class="token punctuation">:</span> <span class="token string">'debug_vars'</span>
  ...
  <span class="token key atrule">script</span><span class="token punctuation">:</span>
    ...
    <span class="token punctuation">-</span> <span class="token string">'env | grep -E "(APP_NAME|ENVIRONMENT|DATABASE_HOST)"'</span></code>`),a(S);var N=s(S,4),z=n(N);t(z,()=>`<code class="language-bash"><span class="token comment"># Test configuration with known environment</span>
