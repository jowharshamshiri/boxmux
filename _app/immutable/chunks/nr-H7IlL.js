...
<span class="token function">grep</span> <span class="token parameter variable">-i</span> error app.log</code>`),n(p);var i=s(p,4),C=a(i);e(C,()=>`<code class="language-bash"><span class="token comment"># Check YAML syntax</span>
...
<span class="token builtin class-name">echo</span> <span class="token string">'&#123;"GetStatus": &#123;&#125;&#125;'</span> <span class="token operator">|</span> <span class="token function">nc</span> <span class="token parameter variable">-U</span> /tmp/boxmux.sock</code>`),n(c);var u=s(c,22),T=a(u);e(T,()=>`<code class="language-yaml"><span class="token key atrule">app</span><span class="token punctuation">:</span>
    ...
    <span class="token punctuation">-</span> <span class="token key atrule">id</span><span class="token punctuation">:</span> <span class="token string">'test'</span>
      ...
      <span class="token key atrule">children</span><span class="token punctuation">:</span>
        <span class="token punctuation">-</span> <span class="token key atrule">id</span><span class="token punctuation">:</span> <span class="token string">'problem_box'</span>
          ...
          <span class="token key atrule">content</span><span class="token punctuation">:</span> <span class="token string">'This demonstrates the issue'</span></code>`),n(u);var m=s(u,6),P=a(m);e(P,()=>`<code class="language-bash"><span class="token comment"># Backup current configuration</span>
...
<span class="token function">clear</span></code>`),n(g);var h=s(g,4),M=a(h);e(M,()=>`<code class="language-bash"><span class="token comment"># Force quit BoxMux</span>
...
<span class="token comment"># Or close terminal window</span></code>`),n(h),E(b,d)}const V=Object.freeze(Object.defineProperty({__proto__:null,default:U,metadata:k},Symbol.toStringTag,{value:"Module"}));export{V as _};
