...
PTY Error State:    &quot;Failed Process ⚡ [Process Stopped]&quot;</code>`),a(m);var g=n(m,20),D=s(g);t(D,()=>`<code class="language-bash"><span class="token comment"># Kill PTY process</span>
...
<span class="token builtin class-name">echo</span> <span class="token string">'&#123;"Command": &#123;"action": "restart_pty", "box_id": "test_runner"&#125;&#125;'</span> <span class="token operator">|</span> <span class="token function">nc</span> <span class="token parameter variable">-U</span> /tmp/boxmux.sock</code>`),a(y);var d=n(y,8),N=s(d);t(N,()=>`<code class="language-yaml"><span class="token punctuation">-</span> <span class="token key atrule">id</span><span class="token punctuation">:</span> <span class="token string">'robust_box'</span>
