...
<span class="token punctuation">&#125;</span></code>`),a(M);var T=s(M,6),vs=n(T);p(vs,()=>`<code class="language-json"><span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),a(T);var P=s(T,10),ws=n(P);p(ws,()=>`<code class="language-python"><span class="token keyword">import</span> socket
...
client<span class="token punctuation">.</span>update_box<span class="token punctuation">(</span><span class="token string">"status"</span><span class="token punctuation">,</span> <span class="token string">"System Online"</span><span class="token punctuation">)</span></code>`),a(P);var A=s(P,4),Bs=n(A);p(Bs,()=>`<code class="language-bash"><span class="token shebang important">#!/bin/bash</span>
...
refresh_box <span class="token string">"cpu_monitor"</span></code>`),a(A);var N=s(A,8),js=n(N);p(js,()=>`<code class="language-bash"><span class="token shebang important">#!/bin/bash</span>
...
<span class="token keyword">else</span>
    ...
    update_box <span class="token string">"build_output"</span> <span class="token string">"<span class="token variable"><span class="token variable">$(</span><span class="token function">cargo</span> build <span class="token parameter variable">--release</span> <span class="token operator"><span class="token file-descriptor important">2</span>></span><span class="token file-descriptor important">&amp;1</span> <span class="token operator">|</span> <span class="token function">tail</span> <span class="token parameter variable">-10</span><span class="token variable">)</span></span>"</span>
<span class="token keyword">fi</span></code>`),a(N);var D=s(N,4),Ss=n(D);p(Ss,()=>`<code class="language-python"><span class="token keyword">import</span> psutil
...
<span class="token punctuation">&#125;</span></code>`),a(F);var H=s(F,8),Os=n(H);p(Os,()=>`<code class="language-python"><span class="token keyword">def</span> <span class="token function">safe_update_box</span><span class="token punctuation">(</span>box_id<span class="token punctuation">,</span> content<span class="token punctuation">)</span><span class="token punctuation">:</span>
    ...
    <span class="token keyword">except</span> Exception <span class="token keyword">as</span> e<span class="token punctuation">:</span>
        ...
        <span class="token keyword">return</span> <span class="token boolean">False</span></code>`),a(H),Ms(G,$)}const $s=Object.freeze(Object.defineProperty({__proto__:null,default:Ps,metadata:K},Symbol.toStringTag,{value:"Module"}));export{$s as _};
