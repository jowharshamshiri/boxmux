...
PACKAGES_DIR="$XB_HOME/packages"
PACKAGE_REPOS_DIR="$XB_HOME/package_repos"
...
RUN_STATE_KEY_FUNCTION_NAME="function_name"
RUN_STATE_KEY_FUNCTION_ARGS="function_args"
RUN_STATE_KEY_UPDATE_ATTEMPTED="update_attempted"
RUN_STATE_KEY_UPDATE_SUCCESSFUL="update_successful"
RUN_STATE_KEY_UPDATE_PULLED="update_pulled"
...
DUCKDB_FILE_NAME="$USER_XB_DIR/boxmux.duckdb"
DUCKDB_FKS=false

CLASS_CHECKS=false

LAYOUTS_DIR="$XB_HOME/layouts"
LAYOUT_ROOT_ELEMENT="layout"
LAYOUT_DEFAULT_REFRESH_INTERVAL=1
LAYOUT_DEFAULT_BOX_FILL=false
LAYOUT_DEFAULT_BOX_FILL_COLOR="black"
LAYOUT_DEFAULT_BOX_FILL_CHAR="█"
LAYOUT_DEFAULT_BOX_BORDER_COLOR="white"
LAYOUT_DEFAULT_BOX_TITLE_COLOR="yellow"
LAYOUT_DEFAULT_BOX_TEXT_COLOR="white"
LAYOUT_BOX_EVENTS=("refresh" "enter" "leave" "exit")
LAYOUT_SCROLL_SIZE=5
